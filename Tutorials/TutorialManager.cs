...
{
    protected TutorialConfirmSingle[] tutorialConfirmsList;
    protected Dictionary<TutorialConfirmSingle, bool> tutorialConfirmsDict;
    ...
    void Awake()
    {
        tutorialConfirmsList = FindObjectsByType<TutorialConfirmSingle>(FindObjectsSortMode.None);
        tutorialConfirmsDict = new Dictionary<TutorialConfirmSingle, bool>();
    ...
    public bool ConfirmMeInList(TutorialConfirmSingle confirm, bool b)
    {
    ...
    {
        foreach (TutorialConfirmSingle confirm in tutorialConfirmsDict.Keys)
        {
